...
if($_POST['submitNews']) {
    ...
    $mail->addAddress('info@datasciencemanagement.pl', 'Info Data Science');
...
EOT;
        ...
        if (!$mail->send()) {
            ...
            $msg = 'Niestety zamknęliśmy już proecs rekrutacyjny, ale jeżeli spodoba nam się twój formularz to na pewno się do Ciebie odezwiemy! :)';
        }
    } else {
